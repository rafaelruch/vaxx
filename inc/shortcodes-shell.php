	...
	<header class="header" id="header">
		...
		<div class="header__inner">
			...
			<nav class="header__nav" role="navigation" aria-label="Principal">
				...
				// Imagem por linha (fallback se term nao tem thumb ACF)
				$linha_fallback_img = array(
					'articulados'     => 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=800&q=70',
					'bateria-de-pesos'=> 'https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?auto=format&fit=crop&w=800&q=70',
					'linha-cardio'    => 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?auto=format&fit=crop&w=800&q=70',
					'acessorios'      => 'https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?auto=format&fit=crop&w=800&q=70',
				);
				?>
				<ul>
					...
					<li class="has-megamenu">
						...
						<div class="megamenu" role="menu">
								...
								<div class="megamenu__col">
									...
									<div class="megamenu__cards">
										<?php foreach ( $linhas as $linha ) :
											$count = $linha->count;
											$img   = isset( $linha_fallback_img[ $linha->slug ] ) ? $linha_fallback_img[ $linha->slug ] : 'https://picsum.photos/seed/' . $linha->slug . '/800/500?grayscale';
										?>
											<a href="<?php echo esc_url( get_term_link( $linha ) ); ?>" class="megamenu__card">
												<div class="megamenu__card-img">
													<img src="<?php echo esc_url( $img ); ?>" alt="<?php echo esc_attr( $linha->name ); ?>">
												</div>
							...
							<div class="megamenu__footer">
								<a href="<?php echo esc_url( vaxx_wa_link() ); ?>" class="megamenu__footer-cta" target="_blank" rel="noopener">Fale com quem fabricou</a>
							</div>
						</div>
					</li>
...
function vaxx_shortcode_footer() {
	...
	$cnpj      = vaxx_get_option( 'cnpj', '00.000.000/0001-00' );
	$ano_desde = vaxx_get_option( 'desde_ano', '2008' );
	$rua       = vaxx_get_option( 'endereco_rua', 'Rua Walter Marquardt, 1234' );
	$bairro    = vaxx_get_option( 'endereco_bairro', 'Distrito Industrial' );
	$cidade    = vaxx_get_option( 'endereco_cidade', 'Jaraguá do Sul / SC' );
	$cep       = vaxx_get_option( 'endereco_cep', '89254-430' );
	...
	<footer class="footer" id="secFooter" role="contentinfo" aria-label="Rodapé">
			...
			<div class="footer__col">
				...
				<div class="footer__address">
					...
					<p class="footer__address-text">
						<strong><?php echo esc_html( $razao ); ?></strong><br>
						<?php echo esc_html( $rua ); ?> — <?php echo esc_html( $bairro ); ?><br>
						<?php echo esc_html( $cidade ); ?> · <?php echo esc_html( $cep ); ?>
					</p>
				</div>
		...
		<div class="footer__bottom">
			<div class="footer__copy">
				...
				<span class="footer__copy-line">CNPJ <?php echo esc_html( $cnpj ); ?> · © <?php echo esc_html( $ano_desde . '–' . date( 'Y' ) ); ?> · Todos os direitos reservados</span>
			</div>
